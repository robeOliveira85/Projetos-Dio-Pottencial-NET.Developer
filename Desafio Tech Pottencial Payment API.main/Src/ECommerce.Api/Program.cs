    ...
    .AddSwaggerGen(options =>
    {
        options.SwaggerDoc("v1", new OpenApiInfo
        {
            ...
            Contact = new OpenApiContact
            {
                ...
                Url = new Uri("https://www.linkedin.com/in/roberto-oliveira-7727b818b/")
            },
            License = new OpenApiLicense
            {
                Name = "MIT",
                Url = new Uri("https://github.com/robeOliveira85/Projetos-Dio-Pottencial.NET.Developer/blob/main/LICENSE")
            }
        });
